...
movies = [
  {
    ...
    "plot": "to surrealistyczna komedia fantastyczna, której akcja toczy się w małym miasteczku o nazwie Owadogród",
  },
  {
    "id": 2,
  ...
  },
  {
    ...
    "plot": "film science fiction i thriller psychologiczny, który został wyreżyserowany przez Christophera Nolana",
  },
  {
    "id": 23,
  ...
  },
  {
    ...
    "plot": "Główny bohater, Bilbo Baggins, wraz z krasnoludami, wyrusza w niebezpieczną podróż przez Pustkowie",
  },
  {
    "id": 53,
    ...
    "plot": "romantyczna komedia-dramat z 2008 roku w reżyserii Woody'ego Allena. Film opowiada historię dwóch przyjaciółek",
  },
  {
    "id": 54,
  ...
  },
  {
    ...
    "actors": ["Adrien Brody", "Thomas Kretschmann", "Michal Zebrowski", "Ed Stoppard"],
  ...
  },
  {
    ...
    "year": 2005,
    "runtime": 132,
    "genres": ["Akcja", "Dramat", "Sci-Fi", "Thriller"],
    "director": "James McTeigue",
    "actors": ["Hugo Weaving", "Natalie Portman", "Stephen Rea", "John Hurt"],
    "plot": "W futurystycznym totalitarnym społeczeństwie, tajemnicza postać znana jako V staje się bohaterem walczącym przeciwko reżimowi i jego represyjnym praktykom. Po spotkaniu z młodą kobietą o imieniu Evey, V rozpoczyna serię zamachów na symbole władzy, w nadziei na obudzenie mas do działania przeciwko tyranii. \"V jak Vendetta\" to opowieść o wolności, sprawiedliwości i odwadze w obliczu ucisku politycznego.",
  }
  {
    "id": 91,
    "title": "Gattaca",
  ...
  },
  {
    ...
    "plot": "oparty na powieści o tym samym tytule autorstwa Huntera S. Thompsona",
  },
  {
    "id": 106,
  ...
  },
  {
    ...
    "year": 2015,
    "runtime": 130,
    "genres": ["Drama", "Comedy", "Historical", "Biography", "Satire"],
    "director": "Adam McKay",
    "actors": [
      "Ryan Gosling",
      "Rudy Eisenzopf",
